...
public class MemberSaveRequestDto {
    ...
    @Builder
    public MemberSaveRequestDto(String user_nm, String user_email, String pwd, String telno, Date subs_dt, String gender, Date bryr, Character prvc_arge, Character user_cls_cd, String rcmdr_email) {
