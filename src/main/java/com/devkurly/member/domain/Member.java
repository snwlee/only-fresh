...
//    }
    ...
    @Builder
    public Member(Integer user_id, String user_nm, String user_email, String pwd, String telno, Date subs_dt, String gender, Character prvc_arge, Character user_cls_cd, String rcmdr_email, Integer pnt) {
        this.user_id = user_id;
