...
public class MemberUpdateFormValidator implements ConstraintValidator<ValidMemberForm, MemberUpdateRequestDto> {
    ...
    @Override
    public boolean isValid(MemberUpdateRequestDto requestDto, ConstraintValidatorContext context) {
        int valid = 0;
