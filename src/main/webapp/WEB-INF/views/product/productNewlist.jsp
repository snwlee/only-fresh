...
<div id="container" style="width:100%; background-color:lightgrey; color:green; text-align:center">
    <ul>
        ...
        <li><a class="btn" href="<c:url value='/product/newlist?order_sc=sel_price'/>">높은 가격순</a></li>
        <li><a class="btn" href="<c:url value='/product/newlist?order_sc=ds_rate'/>">혜택순</a></li>
        <li><a class="btn" href="<c:url value='/product/newlist?order_sc=sales_rate'/>">판매량순</a></li>
        <li><a class="btn" href="<c:url value='/product/newlist?order_sc=in_date'/>">신상품순</a></li>
...
<script>
    ...
    $(document).ready(function (){
        $('#ascBtn').on("click",function (){
            window.location.href = "<c:url value='/product/newlist?order_sc=sel_price'/>";
            window.location.href = "<c:url value='/product/newlist?order_sc=ds_rate'/>";
            window.location.href = "<c:url value='/product/newlist?order_sc=sales_rate'/>";
            window.location.href = "<c:url value='/product/newlist?order_sc=in_date'/>";
        });
