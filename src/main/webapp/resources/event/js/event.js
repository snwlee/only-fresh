...
let resToImgs = (res) => {
    ...
    res.forEach(el => {
        ...
        tmp += "<a style='margin-bottom: 29px' href='" + "/product/newlist?cd_name_num=" + el.cat_cd + "&page=1&pageSize=12&order_sc=in_date&asc=sel_price%20ASC'><img style='width: 100%; height: 200px;' src='" + el.photo + "'/></a>";
