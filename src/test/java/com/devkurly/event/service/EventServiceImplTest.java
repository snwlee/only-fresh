...
public class EventServiceImplTest {
    ...
    public void insertTest() throws Exception {
        ...
        assertTrue(eventService.isValid(nmOverFifty).contains("nm length over 50"));
        ...
        assertTrue(eventService.isValid(desLength).contains("des length over 200"));
...
//        assertTrue(eventService.isValid(photoLength).contains("photo over "))
        ...
        assertTrue(eventService.isValid(photoAltLength).contains("photo_alt length over 100"));
        ...
        assertTrue(eventService.isValid(catCdNull).contains("cat_cd is null"));
        ...
        assertTrue(eventService.isValid(stptDdNull).contains("stpt_dd is null"));
